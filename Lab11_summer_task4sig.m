...
for r = 1:m % m realizations
    ...
    glrtH0(r) = Lab11_summer_glrtqcsig(noiseVec,samplFreq,psdPosFreq,parVec);
end

% Observed GLRT
obsGamma1 = Lab11_summer_glrtqcsig(data1, samplFreq, psdPosFreq, parVec);
obsGamma2 = Lab11_summer_glrtqcsig(data2, samplFreq, psdPosFreq, parVec);
obsGamma3 = Lab11_summer_glrtqcsig(data3, samplFreq, psdPosFreq, parVec);
